/*
 * This is the header file for the realmake_cpp.cpp file. Constants and
 * function headers for realmake_cpp.cpp should go here.
 *
 ...
 */
 ...
 #ifndef REALMAKE_CPP_H
 #define REALMAKE_CPP_H
 
 #include "realmake_base.h"
 
 const std::string GPP = "g++";
 
 class realmake_cpp : public realmake_base {
 	
 	private:
 
 		realmake_cpp();		//Make the default constructor private
 		
 	public:
 		//constructors
 		realmake_cpp(realmake_base &rb);
