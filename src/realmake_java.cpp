/*
 * This is the Java class of the realmake utility. This is where
 ...
 */
 ...
 //constructors
 realmake_java::realmake_java(realmake_base &rb) {
 ...
 int realmake_java::execute_makef() {
